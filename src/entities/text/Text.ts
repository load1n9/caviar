...
export class Text extends Entity {
    ...
    constructor(scene: Scene, font: string, text: string, x:number,y:number, width: number, height: number, size: number = 128, color: RGBA | string = [255, 255, 255, 1]) {
        super(x,y);
        this.width = width;
        this.height = height;
        this.text = text;
        this.font = scene.world.loadFont(font, size, { style: "normal", });
